...
func (x *MountAzureBlobRequest) Reset() {
	*x = MountAzureBlobRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mount_azure_blob_proto_msgTypes[0]
...
func (*MountAzureBlobRequest) Descriptor() ([]byte, []int) {
	return file_mount_azure_blob_proto_rawDescGZIP(), []int{0}
}
...
func (x *MountAzureBlobResponse) Reset() {
	*x = MountAzureBlobResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mount_azure_blob_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MountAzureBlobResponse) Descriptor() ([]byte, []int) {
	return file_mount_azure_blob_proto_rawDescGZIP(), []int{1}
}
...
var File_mount_azure_blob_proto protoreflect.FileDescriptor

var file_mount_azure_blob_proto_rawDesc = []byte{
	0x0a, 0x16, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x5f, 0x62, 0x6c,
	0x6f, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x01, 0x0a, 0x15, 0x4d, 0x6f, 0x75,
...
var (
	file_mount_azure_blob_proto_rawDescOnce sync.Once
	file_mount_azure_blob_proto_rawDescData = file_mount_azure_blob_proto_rawDesc
)

func file_mount_azure_blob_proto_rawDescGZIP() []byte {
	file_mount_azure_blob_proto_rawDescOnce.Do(func() {
		file_mount_azure_blob_proto_rawDescData = protoimpl.X.CompressGZIP(file_mount_azure_blob_proto_rawDescData)
	})
	return file_mount_azure_blob_proto_rawDescData
}

var file_mount_azure_blob_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mount_azure_blob_proto_goTypes = []interface{}{
	(*MountAzureBlobRequest)(nil),  // 0: MountAzureBlobRequest
	(*MountAzureBlobResponse)(nil), // 1: MountAzureBlobResponse
}
var file_mount_azure_blob_proto_depIdxs = []int32{
...
func init() { file_mount_azure_blob_proto_init() }
func file_mount_azure_blob_proto_init() {
	if File_mount_azure_blob_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mount_azure_blob_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mount_azure_blob_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mount_azure_blob_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_mount_azure_blob_proto_goTypes,
		DependencyIndexes: file_mount_azure_blob_proto_depIdxs,
		MessageInfos:      file_mount_azure_blob_proto_msgTypes,
	}.Build()
	File_mount_azure_blob_proto = out.File
	file_mount_azure_blob_proto_rawDesc = nil
	file_mount_azure_blob_proto_goTypes = nil
	file_mount_azure_blob_proto_depIdxs = nil
}
